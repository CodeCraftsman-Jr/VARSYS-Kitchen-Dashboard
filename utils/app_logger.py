...
class AppLogger:
    ...
    def log_startup_info(self):
        ...
        # System information
        self.info(f"🖥️  System Information:")
    ...
    def log_module_import(self, module_name, success=True, error=None):
        ...
        if success:
            self.debug(f"✅ Successfully imported module: {module_name}")
        else:
            self.error(f"❌ Failed to import module: {module_name}")
            if error:
